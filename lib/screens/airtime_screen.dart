            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: PaymentPickerForm(
                  ...
                  pickerLabel: 'Network',
                  loadOptions: () async {
                    final providers = await appState.institutionsApi.listInstitutions(category: 'telecom');
                    return providers.map((p) => PickerOption(id: p.institutionId, label: p.name)).toList();
                  },
                  onSubmit: (name, amountMinor) => appState.initiateAirtimePurchase(name, amountMinor),
